...
**CSV 仓库：** `susansheng/color-mappings`（GitHub）
**CSV URL：** `https://raw.githubusercontent.com/susansheng/color-mappings/main/mappings.csv`
**本地路径：** 克隆到本项目的 `csv/mappings.csv`
